...
'''
Monosdf scenes by Mustafa
'''
base_root = Path(PATH_HOME) / 'data/real/EXPORT_monosdf'
scene_name = 'IndoorKitchenV4_MusVersion'
pose_file = ('json', 'transforms.json')
# frame_id_list = [0]
# shape_file = base_root / scene_name / 'mesh.ply'

im_params_dict={
    'hdr_radiance_scale': hdr_radiance_scale, 
    'sdr_radiance_scale': sdr_radiance_scale, 
    # V2_2/V2_3
    'im_H_load_hdr': 768, 'im_W_load_hdr': 1152, 
    'im_H_load_sdr': 768, 'im_W_load_sdr': 1152, 
    'im_H_load': 768, 'im_W_load': 1152, 
}
if opt.export_format == 'mitsuba':
    ...
    im_params_dict.update({
        ...
        'im_H_resize': 768, 'im_W_resize': 1152, # monosdf
    })
...
scene_obj = realScene3D(
    ...
    modality_filename_dict = {
        ...
        'depth': 'depth_images/img_%04d.npy', 
        'normal': 'normal_images/img_%04d.npy' , 
    }, 
