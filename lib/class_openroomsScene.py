...
from lib.utils_io import load_matrix, load_img, resize_img, load_HDR, scale_HDR, load_depth_binary, load_h5, load_envmap, resize_intrinsics
...
class openroomsScene(object):
    ...
    def valid_modalities(self):
        return ['im_hdr', 'im_sdr', 'albedo', 'roughness', 'depth', 'normal', 'seg', 'lighting_SG', 'lighting_envmap', 'poses']
    ...
    def load_depth(self):
        ...
        self.depth_list = [load_depth_binary(depth_file, (self.im_H_load, self.im_W_load), target_HW=self.im_target_HW, resize_method='area')for depth_file in depth_files] # TODO: better resize method for depth for anti-aliasing purposes and better boundaries, and also using segs?
