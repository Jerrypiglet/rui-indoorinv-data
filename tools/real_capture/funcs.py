...
def process_bracket(_):
    assert False # [!!!!] Tried this on a Mac due to some errors with multiprocessing, but never sorted it out. As a result, the notebook is only tested on Ubuntu so far
